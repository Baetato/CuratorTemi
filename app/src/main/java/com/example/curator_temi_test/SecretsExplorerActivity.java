...
public class SecretsExplorerActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_secrets_explorer);
...
//        하드코딩
        findViewById(R.id.secret1).setOnClickListener(v -> {
            Intent intent = new Intent(this, ActivityMoving.class);
